...
describe('Mongo Query', function() {
    ...
    it('should parse a raw query and filter', function() {
        ...
        assert.deepEqual(mongoQuery.parsedQuery.query,{field2:"a","field1":new Date("2016-01-01T00:00:00Z")},"Invalid  Query")
    });
    ...
    it('should parse a raw query and filter with a default', function() {
        ...
        assert.deepEqual(mongoQuery.parsedQuery.query,{field2:"a","field1":new Date("2016-01-01T00:00:00Z"),field3:3},"Invalid  Query")
    });
});